...
const isTouch = typeof window !== 'undefined' && 'ontouchstart' in window && navigator.maxTouchPoints > 1;
    ...
    <div style={{ width, height, position: 'relative' }}>
      {showScreenshotButton && (
        <button onClick={capture} style={{
          position: 'absolute', border: '1px solid #fff', right: 16, top: 16, zIndex: 10,
      ...
      >
        ...
        <Suspense fallback={<Loader placeholderSrc={placeholderSrc} />}>
          <ModelInner
            ...
            autoFrame={autoFrame} fadeIn={fadeIn} autoRotate={autoRotate} autoRotateSpeed={autoRotateSpeed}
